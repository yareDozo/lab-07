package se331.lab_07.controller;
...
public class Controller {
    ...
    @GetMapping("/events")
    public ResponseEntity<List<Event>> getEventLists(@RequestParam(value = "_limit", required = false) Integer perPage
